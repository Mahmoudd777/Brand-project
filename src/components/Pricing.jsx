    ...
    <div name='pricing' className='w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='text-center py-8 text-slate-300'>
          <Zoom left cascade><h2 className='text-3xl uppercase'>Pricing</h2></Zoom>
          <Zoom right cascade><h3 className='text-5xl font-bold text-white py-8'>The right price for your research.</h3></Zoom>
         <Fade left cascade> <p className='text-3xl'>
         ...
         <Bounce left>
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div className='text-2xl'>
                ...
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
               <Jump forever> <button className='w-full py-4 my-4'>Get Started</button></Jump>
            </div>
          </div>
          </Bounce>
          <Bounce right>
